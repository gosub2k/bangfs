...
TESTS = [    
    ...
    # -------------------------------------------------------------------------
    # PHASE 14: Weird edge cases
    # -------------------------------------------------------------------------
    ("PHASE 14: Weird edge cases", [
          Test("create initial file",
               "dd if=/dev/urandom of='{tmpdir}/bangfs_testfoo' bs=8192 count=100",
               Expected.SUCCESS),

          Test("cp initial file to {mount}",
               "cp '{tmpdir}/bangfs_testfoo' '{mount}/foo'",
               Expected.SUCCESS),
          ...
          Test("cleanup test",
               "rm '{mount}/foo'; rm '{tmpdir}/bangfs_testfoo'",
               Expected.SUCCESS),
    ]),
